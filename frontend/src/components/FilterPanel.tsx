...
import { SlidersHorizontal, Search, CalendarIcon, Tag, User } from 'lucide-react';
...
export function FilterPanel({ filters, onChangeFilters }: FilterPanelProps) {
  ...
  type FilterChangeValue = FilterValue | boolean;
  const handleFilterChange = (key: keyof Filters, value: FilterChangeValue): void => {
    const newFilters = {
      ...localFilters,
      [key]: value || undefined,
    };
  ...
  const handleAdvancedSearchChange = (key: keyof typeof localFilters.advancedSearch, value: string) => {
    const newFilters = {
      ...localFilters,
      advancedSearch: {
          ...
          <div className="grid gap-6 py-4 max-h-[80vh] overflow-y-auto pr-4">
            ...
            <div className="flex items-center space-x-2 mb-4">
              <Checkbox
                ...
                onCheckedChange={(checked) => handleFilterChange('excludeMeetings', checked)}
              />
              <label htmlFor="excludeMeetings" className="text-sm font-medium">
